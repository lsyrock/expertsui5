sap.ui.define([
   ...
   var url = "http://ai.esmplus.com/miniokkage/%EC%A7%80%EB%A7%88%EC%BC%93%EC%98%A5%EC%85%98/g-leggings-190105-2.jpg";

   var PageController = Controller.extend("sap.ui.expertsui5.root.controller.MasterDetail", {
      model: new sap.ui.model.json.JSONModel(),
      data: {
         ProductCollection: [{ Name: "사과", ProductPicUrl: url, ProductId: "apple" },
         { Name: "사과", ProductPicUrl: url, ProductId: "apple" }
         ]
      },
      onInit: function () {
         debugger;
